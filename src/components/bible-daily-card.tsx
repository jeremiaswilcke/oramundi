...
export function BibleDailyCard() {
  ...
  return (
    <section className="pointer-events-auto w-full max-w-4xl">
      <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-primary via-primary/95 to-secondary text-white editorial-shadow">
        ...
        <div className="relative z-10 px-6 py-6 md:px-8 md:py-7">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-xl">
              ...
              <h2 className="mt-4 font-headline text-3xl italic text-white md:text-4xl">
